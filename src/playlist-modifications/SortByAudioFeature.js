...
export default class Sort extends AbstractSort {
  static sort(playlist, order, options) {
    ...
    if (typeof sortBy === 'undefined') {
      throw Error('"options.sortBy must be defined in order to sort by audio feature.');
    }
    if (typeof audioFeatures === 'undefined') {
      throw Error('"options.audioFeatures must be provided in order to sort by audio feature.');
    }
